# code taken from here: https://github.com/lukemelas/EfficientNet-PyTorch/tree/master/efficientnet_pytorch
...
class EfficientNetWrapper(EfficientNet):
    ...
    @classmethod
    def from_pretrained(cls, model_name, dim, task_ids, **override_params):
