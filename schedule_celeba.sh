#!/bin/bash
#SBATCH -p alldlc_gpu-rtx2080    #ml_gpu-teslaP100      #  ml_gpu-rtx2080       # alldlc_gpu-rtx2080
#SBATCH --gres=gpu:1
...
# COMMAND="python -u multi_objective/main.py -m ${arrIN[0]} -d ${arrIN[1]} -s ${arrIN[2]} -t ${arrIN[3]}";
COMMAND="python -u multi_objective/eval_checkpoints.py -m single_task -t 16";
echo "Workingdir: $PWD";
